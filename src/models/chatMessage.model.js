        ...
        const aggregate = await this.aggregate([
            ...
            {$unwind:'$chatRoomInfo.userProfile'},
            {
                $group:{
                    ...
                    type:{$last:'$type'},
                    postedByUser:{$last:'$readByRecipients'},
                    readByRecipients:{$last:'$readByRecipients'},
                    chatRoomInfo:{$addToSet:'$chatRoomInfo.userProfile'},
                    createdAt:{$last:'$createdAt'},
                    updateAt:{$last:'$updatedAt'}
                }
            }
        ]);
        return aggregate[0];
...
chatMessageSchema.statics.getRecentConversation = async function(chatRoomIds, options, currentLoggedUser){
